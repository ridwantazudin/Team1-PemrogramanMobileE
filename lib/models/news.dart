...
List<News> newsList = [
    News(    
        ...
        date: "12 April 2023",
        content: 'REPUBLIK BOBOTOH - Musim kompetisi Liga 1 2022/2023 baru akan berakhir. Setiap klub rata-rata masih memiliki satu pertandingan sisa, termasuk Persib Bandung. Namun sedikit langkah yang berbeda dilakukan oleh tim besutan Luis Milla tersebut. Persib sudah mengumumkan terkait jersey anyar yang kemungkinan dirilis pada Hari Raya Idul Fitri 1444 Hjiriyah. "Persib akan meluncurkan jersey bertemakan 90an, demikian pesan yang disampaikan Persib, Selasa 11 April 2023."',
    ),
    News(
        id: 1,
        views: 200,
    ...
    News(
        ...
        content: 'Mantan Ketua Umum Partai Demokrat Anas Urbaningrum akan segera menghirup udara bebas. Anas memasuki masa cuti menjelang bebas (CMB), Selasa 11 April 2023 dari Lapas Sukamiskin. "Iya benar, tanggal 11 insyaAllah mudah-mudahan tidak ada perubahan lagi. Tanggal 11 Pak Anas untuk menjalani cuti menjelang bebas,"kata Kepala Divisi Pemasyarakatan Kemenkumham Jawa Barat, Kusnali saat dihubungi merdeka.com, Kamis (6/4).',
    ),
    News(
        id: 6,
        views: 150,
        ...
        content:'Video Anas Urbaningrum langsung bertemu Presiden Jokowi, Kapolri Listyo Sigit Prabowo dan Menko Polhukam Mahfud MD di Istana, setelah bebas dari Lapas Sukamiskin adalah tidak benar. Faktanya, tidak ada agenda Anas bertemu dengan Jokowi di Istana setelah bebas dari Lapas Sukamiskin Bandung Jawa Barat. Usai bebas Anas akan ke Blitar untuk bertemu Ibunya. Jangan mudah percaya dan cek setiap informasi yang kalian dapatkan. Pastikan itu berasal dari sumber terpercaya, sehingga bisa dipertanggungjawabkan kebenarannya.',
    ),
    News(
        id: 7,
        views: 180,
    ...
    News(
        ...
        content: 'Mantan Ketua Umum Himpunan Mahasiswa Islam Indonesia (HMI) Anas Urbaningrum resmi bebas bersyarat dari Lapas Sukamiskin, Bandung, Jawa Barat, Selasa (11/4/2023). Seperti diberitakan republika.co.id, bebasnya Anas Urbaningrum disambut oleh ratusan pendukungnya di halaman Lapas Sukamiskin. Anas Urbaningrum pernah menjabat sebagai ketua HMI ke-23. Dia menjabat periode 1997-1999.',
    ),
    News(
        id: 10,
        views: 240,
        ...
        content: 'AMBON, TRIBUNAMBON.COM - Mantan Ketua Korps Alumni Himpunan Mahasiswa Islam (KAHMI) Kota Ambon, Rovik Akbar Afifuddin mengaku terharu dengan bebasnya Anas Urbaningrum. "Kurang lebih 9,3 tahun waktu yang menurut kami cukup lama tapi itu adalah sebuah perjuangan," kata Rovik, Selasa (12/4/2023). Kata dia, semua sahabat, loyalis dan kader HMI akan tetap mendukung apa yang disampaikan Anas Urbaningrum, bahwa apa yang dilakukannya selama ini adalah perjuangan keadilan.'
    ),
];
